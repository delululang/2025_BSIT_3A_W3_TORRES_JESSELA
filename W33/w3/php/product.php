...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    if (!isset($error)) {
        $stmt = $conn->prepare("INSERT INTO products (product_name, price, image, color, size, date_added) VALUES (?, ?, ?, ?, ?, NOW())");
...
<!-- Font Awesome CDN for back arrow icon -->
...
<div class="admin-container">
    ...
    <table>
        ...
        <?php foreach ($products as $p): ?>
            ...
            <td>
                <?php if ($p['image_url']): ?>
                <img class="product-img" src="<?php echo htmlspecialchars($p['image_url']); ?>" alt="<?php echo htmlspecialchars($p['name']); ?>" />
                <?php else: ?>
                No Image
                <?php endif; ?>
            </td>
