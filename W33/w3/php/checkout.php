...
session_start();
include 'connection.php'; // Adjust path if needed (e.g. '../connection.php')
...
$sql = "SELECT ci.quantity, p.product_name, p.price, p.image_path 
        FROM cart_items ci 
          ...
          <section class="payment-section">
            ...
            <div class="payment-options">
              ...
              <div class="payment-option">
                ...
                <label for="gcash">
                  <img src="images/gcash-logo.png" alt="GCash" class="payment-logo" />
                  <span>GCash</span>
                </label>
              </div>
              <div class="payment-option">
                ...
                <label for="paymaya">
                  <img src="images/paymaya-logo.png" alt="PayMaya" class="payment-logo" />
                  <span>PayMaya</span>
                </label>
              </div>
            </div>
                ...
                <?php foreach ($cart_items as $item): ?>
                  <div class="order-item">
                    <div class="item-image">
                      <img src="<?= htmlspecialchars($item['image_path'] ?? 'images/default-product.jpg') ?>" alt="<?= htmlspecialchars($item['product_name']) ?>" />
